...
export function buildAiPayload(analysis) {
  ...
  const payload = {
    ...
    pricing: R.priceConfig && R.priceConfig.market !== null ? { market: r2(R.priceConfig.market), entry: r2(R.priceConfig.entry), ceiling: r2(R.priceConfig.ceiling), withCoupons: r2(R.priceConfig.marketEff), analogs: R.priceConfig.analogs, matchTier: R.priceConfig.tier } : null, // spec 013
    promo: R.config?.promo?.known ? { listings: R.config.promo.known, couponRevShare: r3(R.config.promo.coupon.revShare), dealRevShare: r3(R.config.promo.deal.revShare), discountRevShare: r3(R.config.promo.discount.revShare), avgDiscountPct: r2(R.config.promo.discount.avgPct), saturation: R.config.promo.saturation } : null, // spec 014
