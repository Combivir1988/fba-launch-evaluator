...
export function buildAiPayload(analysis) {
  ...
  const payload = {
    ...
    cashflow: R.cashflow && !R.cashflow.pending ? { peakInvestment: r2(R.cashflow.peak), peakMonth: R.cashflow.peakMonth, batches: R.cashflow.batches, unitsPurchased: R.cashflow.unitsPurchased, paybackMonth: R.cashflow.paybackMonth, monthsModelled: R.cashflow.rows.length - 1,
      endBalance: r2(R.cashflow.endCum), stockValueAtEnd: r2(R.cashflow.stockValueEnd), stockoutMonths: R.cashflow.stockoutMonths, startSalesMonthly: r2(R.cashflow.startSales), startSource: R.cashflow.startSource, targetSalesMonthly: R.cashflow.targetMonthly, assumptions: R.cashflow.assumptions } : null,
