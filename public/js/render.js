...
(function () {
  ...
  function priceBlock(A, R, o) {
    ...
    const tierTxt = pc.tier === null ? "" : pc.tier === 1 ? "совпали все выбранные поля" : `совпало ≥ ${Math.round(pc.tier * 100)} % полей`;
    const cards = pc.market === null ? `<div class="notice" style="margin-top:.5rem">${esc(pc.warn || "аналогов нет")}</div>` : `<div class="cards" style="margin-top:.5rem">
